...
#ifndef JOB_SEEKER_SWIFT_H
#define JOB_SEEKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="job_seeker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10job_seeker11AppDelegate")
...
SWIFT_CLASS("_TtC10job_seeker17MainFlutterWindow")
